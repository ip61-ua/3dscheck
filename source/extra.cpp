...
void
m_useColor (int c1, int c2, int c3)
{
  uc1 = c1;
  uc2 = c2;
  uc3 = c3;
...
int
touchWithin (float chX, float chY, float tX, float tY, float bX, float bY)
{
...
void
adv_background (int c1, int c2, int c3)
{
...
void
m_rect (int x1, int y1, int x2, int y2)
{
